angular.module('MeganimesApp')
  .controller('AnimesController', function ($scope, AnimesFactory, $http, $ionicSideMenuDelegate, $ionicPopup, $ionicLoading, $timeout, $ionicScrollDelegate, $ionicFilterBar, $ionicHistory, $ionicPlatform) {
    $scope.titulo = "Animes";
    $scope.refresh = true;
    ...
    $scope.loadMore = function () {
      $http.get('http://meganimes.16mb.com/api/animes?page=' + $scope.pag).success(function (response) {
    ...
    $scope.doRefresh = function () {
      ...
      $scope.more = true;
      $http.get('http://meganimes.16mb.com/api/animes?page=1')
