...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    max: 5
  }).controller('RatingController', function($scope, $attrs, ratingConfig, $localStorage) {
    var ngModelCtrl;
    ngModelCtrl = {
    ...
    return {
      ...
      template: '<ul class="rating" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)" style=\"display: inline\"><i class="icon" ng-class="value === undefined ? (r === 1 ? \'ion-ios-star\' : (r === 2 ? \'ion-ios-star-half\' : \'ion-ios-star-outline\')) : (value > $index ? (value < $index+1 ? \'ion-ios-star-half\' : \'ion-ios-star\') : \'ion-ios-star-outline\')" ng-style="{\'color\': \'#6495ed\', \'font-size\': \'xx-large\'}"></i></li>' + '</ul>',
      replace: true,
